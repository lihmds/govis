...
class BoardPainter:
  ...
  def draw_black_stone(self, x, y, opacity):
    self.draw_stone(x, y, opacity, color_scheme['black'])

  def draw_white_stone(self, x, y, opacity):
    self.draw_stone(x, y, opacity, color_scheme['white'])
